...
public class SendContext {
    ...
    /** Send wallet released time */
    public static final long SEND_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME = 1500940800;

    // report mail
    public static final String REPORT_EMAIL = "wallet@socialsend.io";
    /** Subject line for manually reported issues. */
    public static final String REPORT_SUBJECT_ISSUE = "Reported issue";

    /** Donation address */
    public static final String DONATE_ADDRESS = "ScbTnndCjzLY688EcWFn3x83WDpfvb56EM";
    ...
    public static final class Files{
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "send-wallet-backup" +"_"+ FILENAME_NETWORK_SUFFIX;
