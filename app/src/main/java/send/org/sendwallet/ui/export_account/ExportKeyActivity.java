package send.org.sendwallet.ui.export_account;
...
import send.org.sendwallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = sendModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(SendContext.NETWORK_PARAMETERS);
