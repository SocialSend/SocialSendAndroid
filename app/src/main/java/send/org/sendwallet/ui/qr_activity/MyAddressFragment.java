...
import static send.org.sendwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(SendModule sendModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(sendModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = SendApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String sendUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(sendUri,address.toBase58());
            }
    ...
    public void setModule(SendModule module) {
        this.module = module;
    }
