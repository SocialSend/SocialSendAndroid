package send.org.sendwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = sendModule.backupWallet(backupFile, firstPassword);

            if (result){
                sendApplication.getAppConf().setHasBackup(true);
