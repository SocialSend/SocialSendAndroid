package send.org.sendwallet.ui.words_restore_activity;
...
import static send.org.sendwallet.module.SendContext.SEND_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
                        ...
                        new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                try {
                                    ...
                                    sendModule.checkMnemonic(mnemonic);

                                    boolean isBip32 = check_bip32.isChecked();

                                    sendModule.restoreWallet(mnemonic, SEND_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, SendContext.ENABLE_BIP44_APP_VERSION));
