...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final SendApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (SendContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + SendContext.NETWORK_PARAMETERS.getId() + "\n");
